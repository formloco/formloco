...
const emailSignupSQL = async (data) => {
  ...
  await clientTenant.query(`CREATE TABLE "public"."files" ("tenant_id" uuid, "form_id" uuid, , "file_id" uuid, "file_name" text, "type" text, "image" text, "date_created" timestamp, "date_archived" timestamp, "user_created" text)`)
